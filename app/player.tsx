                    ...
                    : 
                        <Form onSubmit={sendAnswer}>
                            ...
                            <div className="flex items-end justify-center gap-2">
                                <InputText label={lang !== "TR" ? "Answer" : "Cevap"} value={answer} onInput={answerChange} disabled={room_.users[userIndex].answer !== ""} />
                                <ButtonPrimary type="submit" disabled={room_.users[userIndex].answer !== ""}>
                                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 -960 960 960"><path d="M120-160v-640l760 320-760 320Zm60-93 544-227-544-230v168l242 62-242 60v167Zm0 0v-457 457Z"/></svg>
                                </ButtonPrimary>
                            </div>
                        </Form>
                    }
